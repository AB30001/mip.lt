...
**Current phase:** 2 — Crawl and indexation integrity (in progress; technical fixes shipping) → next 5 on-page templates largely underway
...
- [ ] Current rankings/visibility baseline — unavailable without GSC export (unknown)
- [x] Domain authority baseline (SiteProfiler overview 2026-09-20)
...
- [ ] Homepage title/H1 refresh for `mano ip` — planned, not shipped this pass
- [ ] Spot-check rendered HTML post-deploy

### Phase 6 — Content production
- [ ] Homepage / speed-test copy briefs from SERPs — next
- [-] No mass new pages without approval

### Phase 7 — Off-page and links
- [x] Backlink baseline captured
- [x] Spam patterns flagged (B5)
- [ ] Owner decision on disavow

### Phase 8 — Tracking and review cadence
- [ ] SERPWatcher tracking — after homepage/speed-test refresh published
- [ ] Next review 2026-09-27

## Baseline
| Metric | Value | Source | Measured |
| --- | --- | --- | --- |
| Domain Authority | 17 | Mangools SiteProfiler | 2026-09-20 |
| Page Authority | 33 | SiteProfiler | 2026-09-20 |
| Citation Flow / Trust Flow | 22 / 21 | SiteProfiler | 2026-09-20 |
| Referring domains / backlinks | 155 / ~380 | SiteProfiler backlink profile | 2026-09-20 |
| `mano ip` volume / KD | 2500 / 17 | KWFinder LT | 2026-09-20 |
| `interneto greičio testas` volume / KD | 220 / 16 | KWFinder LT | 2026-09-20 |
| `it naujienos` volume / KD | 70 / 23 | KWFinder LT | 2026-09-20 |
| Organic rankings | unknown | GSC not exported | — |
...
| --- | --- | --- | --- |
| Homepage on-page refresh for `mano ip` | high | agent | next |
| Speed-test title/meta toward `interneto matuokle` | medium | agent | next |
| SERPWatcher after tool-page refresh | medium | agent | after deploy |
| SERPWatcher setup | medium | agent | pages refreshed + indexable |
...
| 2026-09-21 | No EN homepage URL; keep geo EN UX on `/` | Avoid cannibalization; EN SEO only via `/speed-test` |
